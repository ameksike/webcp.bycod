...
$idiom['main']['btn']["save"] = "Salvar";
$idiom['main']['btn']["cancel"] = "Cancelar";
$idiom['main']['btn']["send"] = "Enviar";
$idiom['main']['btn']["edit"] = "Editar";
$idiom['main']['btn']["remove"] = "Eliminar";
$idiom['main']['btn']["add"] = "Adicionar";
$idiom['main']['btn']["modify"] = "Modificar";
$idiom['main']['btn']["update"] = "Actualizar";
$idiom['main']['btn']["reload"] = "Recargar";
$idiom['main']['btn']["new"] = "Nuevo";
...
$idiom['news']['form']['title']['label'] = 'Titulo';
$idiom['news']['form']['title']['placeholder'] = 'Escriba el Titulo';
$idiom['news']['form']['date']['label']  = 'Fecha';
$idiom['news']['form']['date']['placeholder']  = 'Escriba la Fecha';
$idiom['news']['form']['author']['label']  = 'Autor';
$idiom['news']['form']['author']['placeholder']  = 'Escriba el nombre del Autor';
$idiom['news']['form']['category']['label']  = 'Categoría';
$idiom['news']['form']['category']['placeholder']  = 'Escriba la Categoría';
$idiom['news']['form']['Icon']['label']  = 'Icono';
$idiom['news']['form']['Icon']['placeholder']  = 'Icono';
$idiom['news']['form']['cover']['label']  = 'Portada';
$idiom['news']['form']['cover']['placeholder']  = 'Portada';
$idiom['news']['form']['sumary']['label']  = 'Preámbulo';
$idiom['news']['form']['sumary']['placeholder']  = 'Escriba el Preámbulo';
$idiom['news']['form']['description']['label']  = 'Descripción extendida';
$idiom['news']['form']['description']['placeholder']  = 'Escriba la Descripción extendida';
...
$idiom['news']['list']['action']['add'] = 'Adicionar';
$idiom['news']['list']['action']['update'] = 'Actualizar';
$idiom['news']['list']['action']['delete'] = 'Eliminar';
$idiom['news']['list']['action']['list'] = 'Listar';
$idiom['news']['list']['action']['get'] = 'Obtener';
...
$idiom['person']['sex']['M'] = "Masculino";
$idiom['person']['sex']['F'] = "Femenino";
...
$idiom['dashboard']['menu'][3]['menu'][6]['title'] = "Externas";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][0]['title'] = "EICMA";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][0]['menu'][0]['title'] = "FTP";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][0]['menu'][1]['title'] = "OTRA";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][1]['title'] = "OSDE";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][1]['menu'][0]['title'] = "Conferencia";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][1]['menu'][1]['title'] = "Vinacon";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][2]['title'] = "GOB";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][2]['menu'][0]['title'] = "Gaceta";
$idiom['dashboard']['menu'][3]['menu'][6]['menu'][2]['menu'][1]['title'] = "Energia";
...
$idiom['tool']['config']['subtitle'] = "Herramientas";
$idiom['tool']['config']['title'] = "Configuración";
$idiom['tool']['desing']['subtitle'] = "Herramientas";
$idiom['tool']['desing']['title'] = "Diseño";
$idiom['tool']['module']['subtitle'] = "Herramientas";
$idiom['tool']['module']['title'] = "Modulos";
